...
class WordFrequencySummarization(SummarizationInterface):
    def __init__(self, language="english", threshold_constant=1.35, min_sentence_length=6):
    ...
    def summarize(self, text, top_n=10):
        ...
        summary = self.generate_summary(sentences, sentence_scores, self.threshold_constant * threshold)
